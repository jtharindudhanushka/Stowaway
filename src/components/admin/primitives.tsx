...
export function Toggle({
  ...
  return (
    <div className="flex items-start justify-between gap-4 py-3">
      <div className="min-w-0">
        <label htmlFor={id} className={['text-sm font-bold text-slate-900', disabled ? 'opacity-50' : 'cursor-pointer'].join(' ')}>
          {label}
        </label>
      ...
      <button
        ...
        className={[
          'relative w-11 h-6 rounded-full flex-shrink-0 transition-colors mt-0.5',
